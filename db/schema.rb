...
ActiveRecord::Schema.define(version: 20160828062703) do

  create_table "confirmados", force: :cascade do |t|
  ...
  create_table "shoppe_countries", id: false, force: :cascade do |t|
    t.string "init", limit: 1, null: false
  end
